Address.Data = Address.Data || (function() {
  ...
  return {
    ...
    _spouse_address_data_store:function(_name,_contact_id){
      var self=this;
      self._address_data_store(_name, self.end_point.address_get + "&contact_id=" + _contact_id);
    }
  }
}());
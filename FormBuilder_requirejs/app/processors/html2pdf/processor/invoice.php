    ...
    <table style="width: 99%;border: none;" cellspacing="4mm" cellpadding="0">
        <tr>
            <td style="width: 100%">
                ...
                <div class="zone" style="height: 3mm;position: relative;font-size: 3mm; background:url(../../../imgs/invoice_header.jpg);">
                    ...
                    <!--<div style="position: absolute; left: 3mm; text-align: left; ">
                      	 <?php 
							...
							else
							{
								...
								echo '&nbsp;&nbsp;&nbsp;&nbsp;'. $payment_status .' - ' .date('d/m/Y  H:i:s'). '<br />';
							}
            ...
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 40mm;font-size:2mm; top:10mm;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="detail">
                      <tr bgcolor="#CAE4FF">
                        <th width="150" bgcolor="#EAEAEA">Item</th>
                        ...
                        <th width="90" bgcolor="#EAEAEA" align="right">Amount</th>
                      </tr>
                      ...
                      <?php 
					  	for ($i = 0; $i <= $nrows; $i++) {
							...
							echo '
								<tr>
									<td width="150" align="left">'.$arrr[0].'</td>
									<td width="200" align="left">'.$arrr[1].'</td>
									<td width="70" align="right">'.$arrr[2].'</td>
									<td width="90" align="right">'.$arrr[3].'</td>
									<td width="90" align="right">'.$arrr[4].'</td>
							  	</tr>
							';
						};?>
...
<?php
    ...
    try
    {
		...
		$html2pdf->Output($pdf_saving_path.'invoice_'.$invoice_id.'.pdf', 'F');

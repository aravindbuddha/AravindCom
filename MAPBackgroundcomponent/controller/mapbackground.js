...
var mapbackground = {
	...
	,_form: function (uid, task) {
		...
		self.form[uid].setItemValue('contact_ID', self.configuration[uid].contact_id);
...
if(task == 'Edit'){
    ...
    ,_datastor: function (uid) {
        var self = this;
        var postStr = "contactid="+self.configuration[uid].contact_id+"&agencyid="+self.configuration[uid].agencyid;

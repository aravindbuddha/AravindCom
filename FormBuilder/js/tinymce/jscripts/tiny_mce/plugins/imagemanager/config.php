...
// echo 'joseph'; echo MCMANAGER_ABSPATH;
// ini_set('error_reporting',E_ALL);
//ini_set('display_errors', 'On');
include_once('../../../../../../../userhome/$ettings.php');
//echo 'joseph';exit();
// * * * * ImageManager config
// General options
$mcImageManagerConfig['general.theme'] = "im";
$mcImageManagerConfig['general.tools'] = "filemanager,createdir,upload,refresh,addfavorite,removefavorite,insert,delete,edit,preview"; // "filemanager" button if you have "filemanager.urlprefix" configured.
...
define("USER_FILE_PATH", $_COOKIE['cookie_users_userid'] . '/');
$Folder = "/var/www/html/userhome/userfiles/" . USER_FILE_PATH;

$mcImageManagerConfig['filesystem.path'] = $Folder; // absolute or relative from this script path, optional.
//Root upto the users folder
$mcImageManagerConfig['filesystem.rootpath'] = $Folder; // absolute or relative from this script path, required.
$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^$/i';
...
$mcImageManagerConfig['thumbnail.folder'] = $_COOKIE['cookie_users_userid']; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
$mcImageManagerConfig['thumbnail.auto_generate'] = false;
...
$mcImageManagerConfig['thumbnail.prefix'] = $_COOKIE['cookie_users_userid'] . "_"; //

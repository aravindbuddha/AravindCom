...
class Moxiecode_ImageManagerPlugin extends Moxiecode_ManagerPlugin {
    ...
    function _createThumb(&$man, &$file) {
        ...
        if ($_COOKIE['cookie_users_userid'] != $config['thumbnail.folder'])
            $havethumbnail = false;
        ...
        if ((!$thumbnail->exists()) && ($config['thumbnail.auto_generate'] == true)) {

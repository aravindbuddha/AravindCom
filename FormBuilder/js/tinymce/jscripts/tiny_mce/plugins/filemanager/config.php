...
$mcFileManagerConfig['filesystem.path'] = $Folder; // absolute or relative from this script path.
$mcFileManagerConfig['filesystem.rootpath'] = $Folder; // absolute or relative from this script path.

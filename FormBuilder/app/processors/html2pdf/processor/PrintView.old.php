<?php	
	...
	$agency_id = str_replace("'", "''",$_POST['agency_id']);
	$userid = $_POST['userID'];
	$connid= $_POST['connID'];
	$connectionid = $_POST['connectionID'];
	
	$agency_logo = $_GET["agency_logo"];
	...
	$future_placement_text = $_POST['future_placement_text'];
	$child_specific_placement = $_POST['child_specific_placement'];
	$child_specific_placement_text = $_POST['child_specific_placement_text'];
	...
	$past_marriages_applicable = $_POST['past_marriages_applicable'];
	...
	$approving_authority_text = $_POST['approving_authority_text'];
	...
	//========***************** CAIRS Dropdowns
	$childhood_family_adaptability_1 = $_POST['chood_fam_adapt_1'];
	$childhood_family_adaptability_2 = $_POST['chood_fam_adapt_2'];
	...
	$childhood_history_deprivation_1 = $_POST['chood_his_dep_1'];
	$childhood_history_deprivation_2 = $_POST['chood_his_dep_2'];
	$childhood_history_victimization_1 = $_POST['chood_his_victim_1'];
	$childhood_history_victimization_2 = $_POST['chood_his_victim_2'];
	...
	$minors_residing_frequently_home = $_POST['minors_residing_home'];
	$adult_sons_daughters = $_POST['adult_sons_daughters'];
	$adults_residing_frequently_home = $_POST['adults_residing_home'];
	...
	$relationship_spouse_partner_family_1 = $_POST['rel_spouse_part_fam_1'];
	$relationship_spouse_partner_family_2 = $_POST['rel_spouse_part_fam_2'];
	$cleanliness_orderliness_maintenance = $_POST['cleanliness_ords_maint'];
	$safety = $_POST['safety'];
	...
	$therapeutic_educational_resources_1 = $_POST['ther_edu_res_1'];
	$therapeutic_educational_resources_2 = $_POST['ther_edu_res_2'];
	...
	$applicant_other_criminal_text = $_POST['applicant_other_criminal_text'];
	$references_text = $_POST['references_text'];
	...
	///========***************** Signatures
	$signature_practitioner1 = $_POST['signature_practitioner1'];	
	if (strlen($signature_practitioner1) > 4){
		$signature_practitioner1 = "<img src='". str_replace(' ','%20',$signature_practitioner1) ."' width='200' height='50'/>";
	}

	$signature_supervisor1 = $_POST['signature_supervisor1'];	
	if (strlen($signature_supervisor1) > 4){
		$signature_supervisor1 = "<img src='". str_replace(' ','%20',$signature_supervisor1) ."' width='200' height='50'/>";
	}

	$signature_practitioner2 = $_POST['signature_practitioner2'];
	if (strlen($signature_practitioner2) > 4){
		$signature_practitioner2 = "<img src='". str_replace(' ','%20',$signature_practitioner2) ."' width='200' height='50'/>";
	}
	$signature_supervisor2 = $_POST['signature_supervisor1'];
	if (strlen($signature_supervisor2) > 4){
		$signature_supervisor2 = "<img src='". str_replace(' ','%20',$signature_supervisor2) ."' width='200' height='50'/>";
	}
	
	$signature_approving_authority = $_POST['signature_approving_authority'];
	if (strlen($signature_approving_authority) > 4){
		$signature_approving_authority = "<img src='". str_replace(' ','%20',$signature_approving_authority) ."' width='200' height='50'/>";
	}
...
em {font-size: 10px;}
.header, .footer {text-align: right;color:#999; font-size:10px;}
-->
</style>
...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
    ...
    <page_footer backleft="10mm" backright="10mm">
          ...
          <col style="width:22%" />
            <tr>
                <td style="text-align: left; padding-left:30px" class="footer">Consortium for Children, &copy; 2013 all rights reserved – Structured Analysis Family Evaluation v03.09.2013</td>
                <td style="text-align: right;" class="footer">[[page_cu]]</td>
            </tr>
        </table>
    </page_footer>
    <img src="http://<?php echo $_SERVER['SERVER_NAME']?>/userhome/agency/<?php echo $agency_logo ?>" alt="logo" style="margin-top: 3mm; width:200px">
	    ...
	    <tr>
    	    <td>
            	<table>
                	...
                	<col style="width:60%" />
                	<tr>
						<td height="90" valign="top"><b>Home study was completed by:</b></td>
	    ...
	    <tr>
    	    <td>
            	<table>
		    		...
		    		<tr>
		    			<td><strong>Language(s):</strong> <?php echo $language1; ?></td>
...
<?php };?>
	...
	<?php if($past_marriages_applicable == "1")
	{
	?>
		<tr>
    	    <td>
            	<table>
					<col style="width: 100%">
		    		<tr>		    			
			        	<td align="left"><br /><strong>Past Marriage</strong></td>
			    	</tr>
				</table>
            </td>
	    </tr>
...
<?php };?>
    ...
    <p><?php echo $applicant_other_criminal_text; ?></p>
...
<?php };?>
    ...
    <p><?php echo $home_and_community; ?></p>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>APPLICANT PROFILE: <?php echo $first_name1; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $applicant_profile_first1; ?></p>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>APPLICANT PROFILE: <?php echo $first_name2; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $applicant_profile_first2; ?></p>
...
<?php };?>
    ...
    <p><?php echo $legal_financial_notifications; ?></p>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>PSYCHOSOCIAL EVALUATION REPORT - HISTORY: <?php echo $first_name1; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $psychosocial_evaluation_report; ?></p>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>PERSONAL CHARACTERISTICS: <?php echo $first_name1; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <?php echo $personal_characteristics_first; ?>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>HISTORY: <?php echo $first_name2; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $history_first_name; ?></p>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>PERSONAL CHARACTERISTICS: <?php echo $first_name2; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $characteristics_first_name; ?></p>
...
<?php };?>
    ...
    <p><?php echo $marital_relationship; ?></p>
...
<?php };?>
    ...
    <p><?php echo $residing_frequently_home; ?></p>
...
<?php };?>
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>EXTENDED FAMILY RELATIONSHIPS: <?php echo $first_name1; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $relationships_first_name1; ?></p>
...
<?php };?>
    ...
    <table class="wrap">
	    ...
	    <thead>
    	    <tr>
        	    <th>EXTENDED FAMILY RELATIONSHIPS: <?php echo $first_name2; ?></th>
	        </tr>
    	</thead>
	    <tr>
			<td></td>
    ...
    <p><?php echo $relationships_first_name2; ?></p>
...
<?php };?>
    ...
    <p><?php echo $physical_social_environment; ?></p>
...
<?php };?>
    ...
    <p><?php echo $general_parenting; ?></p>
...
<?php };?>
    ...
    <p><?php echo $specialized_parenting2; ?></p>
...
<?php };?>
    ...
    <p><?php echo $placement_considerations; ?></p>
...
<?php };?>
        ...
        <tr>
        	<td>
            	<table>
                	...
                	<col style="width: 50%">
                    <tr>
                    	<td valign="top" style="border: #000 1px solid; vertical-align: top; padding:2px;">
	                        <p><strong>Home Study Practitioner:</strong></p>
		                	<?php echo $home_study_practitioner; ?>
                		</td>
		            	<td valign="top" style="border: #000 1px solid; vertical-align: top; padding:2px;">
                    ...
                    <tr>
                    	<td height="50" align="center" valign="top">(Signature)<br /><? echo $signature_practitioner1; ?></td>
                        <td align="center" valign="top">(Signature)<br /><? echo $signature_supervisor1; ?></td>
                    </tr>
                    <tr>
    ...
    <?php if (!empty($approving_authority)){?>
    <table class="wrap">
    	<col style="width: 100%">
	    <thead>
    	    <tr>
        ...
        <tr>
           	  <td><p><?php echo $approving_authority_text; ?> </p></td>
		</tr>
        <tr align="center">
           	  <td height="50" align="center" valign="top">(Signature)<br /><? echo $signature_approving_authority; ?></td>
		</tr>
		<tr>
    ...
    <?php }; //end if $approving_authority ?>
</page>
        ...
        <tr>
        	<td>
	        	<table>
                	...
                	<col style="width: 50%">
			        <tr align="center">
						<td height="50" align="center" valign="top">(Signature)<br><br><br><br>_____________________________<br><?php echo $first_name1; ?></td>
                        <td align="center" valign="top">(Signature)<br><br><br><br>_____________________________<br><?php echo $first_name2; ?></td>
					</tr>
					<tr>
	    ...
	    <tr>
    	    <td>
            	<table>
					...
					<col style="width: 50%">
    				<tr>
						<td><strong>Applicant #1:</strong> <?php echo $first_name1; ?></td>
                        <td><strong>Applicant #2:</strong> <?php echo $first_name2; ?></td>
					</tr>
                    <tr>
						<td valign="top">
                        	<table class="bordasimples">
								...
								<tr>
                    				<td align="center"><?php echo $history_alcohol_drug_1; ?></td>
								...
								<tr>
		    	                    ...
		    	                    <td align="center"><?php echo $crime_arrest_allegations_2; ?></td>
								...
								<tr>
        			            	<td align="center"><?php echo $occupational_history_1; ?></td>
		        	                <td align="center"><?php echo $occupational_history_2; ?></td>
	                      ...
	                      <td valign="top">
    	                   	<table class="bordasimples">
                                ...
                                <tr>
			                        ...
			                        <td align="center"><?php echo $child_development_2; ?></td>
        ...
        <tr>
        	<td>
            	<table>
                	...
                	<col style="width: 50%">
                    <tr>
                    	<td height="50" align="center" valign="top">(Signature)<br /><? echo $signature_practitioner2; ?></td>
                        <td align="center" valign="top">(Signature)<br /><? echo $signature_supervisor2; ?></td>
                    </tr>
                    <tr>
            			<td><strong>Name of the Home Study practitioner:</strong><br /> <?php echo $name_home_study_practitioner; ?></td>
		            	<td><strong>Name of supervisor:</strong><br /> <?php echo $name_supervisor; ?></td>
...
<?php
	...
	{		
		...
		$outputfile = '../../../pdf/tmp/Safe_Form.pdf';
	...
	else
	{
		...
		$outputfile = $pathfile .'Safe_Form_'. $first_name1 .'.pdf';
